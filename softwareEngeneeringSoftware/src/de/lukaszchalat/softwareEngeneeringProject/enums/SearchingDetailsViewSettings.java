...
public class SearchingDetailsViewSettings 
{
	...
	public static String[] getFloors()
	{
		...
		{
			floors.add( new Integer( i ).toString() + " pi�tro" );
		}
	...
	public static String[] getNumbersOfPeople()
	{
		...
		{
			if( i == 1 ) numbersOfPeople.add( new Integer( i ).toString() + " go�cia" );
			else numbersOfPeople.add( new Integer( i ).toString() + " go�ci" );
		}
	...
	public static String[] getNumbersOfRooms()
	{
		...
		{
			if( i == 1 ) numbersOfRooms.add( new Integer( i ).toString() + " pok�j" );
